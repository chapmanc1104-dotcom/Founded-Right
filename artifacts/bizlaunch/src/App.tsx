...
function AuthScreens({ mode, setMode }: { mode: "signin" | "signup" | "forgot"; setMode: (m: "signin" | "signup" | "forgot") => void }) {
  ...
  const googleBtn = (
    <button type="button" onClick={handleGoogleSignIn} disabled={loading} style={{ width: "100%", background: "#1a1a1e", border: "1px solid #2a2a2e", borderRadius: 10, padding: "11px 14px", color: "#c0bdb8", fontSize: 14, fontWeight: 500, cursor: loading ? "not-allowed" : "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 10, opacity: loading ? 0.7 : 1 }}>
